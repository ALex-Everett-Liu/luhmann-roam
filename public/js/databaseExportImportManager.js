...
window.DatabaseExportImportManager = (function () {
  ...
  function initialize() {
    ...
    const exportButton =
      document.getElementById("export-database") || createExportButton();
    const importButton =
      document.getElementById("import-database") || createImportButton();
  ...
  function openExportModal() {
    ...
    modalContent.style.cssText =
      "width: 500px !important; max-width: 500px !important; box-sizing: border-box; margin: 0; padding: 20px; background-color: white;";
