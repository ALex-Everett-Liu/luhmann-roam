...
const CommandPaletteManager = (function () {
  ...
  function saveCommandUsageCounts() {
    try {
      localStorage.setItem(
        "command_palette_usage_counts",
        JSON.stringify(commandUsageCounts),
      );
    } catch (error) {
  ...
  function saveRecentCommands() {
    try {
      localStorage.setItem(
        "command_palette_recent_commands",
  ...
  function trackCommandUsage(commandName) {
    ...
    console.log(
      `Incremented usage count for command "${commandName}" to ${commandUsageCounts[commandName]}`,
    );
  ...
  function scrollToSelectedCommand() {
    const selectedElement = commandsList.querySelector(
  ...
  function renderCommandsList() {
    ...
    if (!query && validRecentCommands.length > 0) {
      ...
      if (selectedCommandIndex < validRecentCommands.length) {
        ...
        filteredCommands = validRecentCommands.concat(
          commands.filter(
            (cmd) =>
    ...
    infoElement.textContent =
      "Use ↑↓ to navigate, Enter to execute, Escape to close";
  ...
  function registerCommand(command) {
    ...
    const existingCommandIndex = commands.findIndex(
          ...
          if (focusedNode) {
            ...
            if (nodeId && window.deleteNode) {
              if (
                confirm(
                  window.I18n
                    ? window.I18n.t("confirmDeleteNode")
        ...
        action: () => {
          if (window.lastFocusedNodeId) {
            const nodeElement = document.querySelector(
              `.node[data-id="${window.lastFocusedNodeId}"]`,
            );
            if (nodeElement) {
      ...
      action: async () => {
        ...
        if (nodeId) {
          if (window.copyContentBetweenLanguages) {
            try {
              const success = await window.copyContentBetweenLanguages(
                nodeId,
                "en-to-zh",
              );
              if (!success) {
            ...
            console.error(
              "copyContentBetweenLanguages function not available on window object",
            );
            alert(
              "Copy function not available. Please ensure the app is fully loaded.",
            );
          }
        } else {
      ...
      registerCommand({
        ...
        action: () => {
          if (window.TaskStatisticsManager.open) {
            ...
            setTimeout(() => {
              const taskGroupsTab = document.querySelector(
                '.tab-button[data-tab="task-groups"]',
              );
              if (taskGroupsTab) {
                taskGroupsTab.click();
              }
      ...
      registerCommand({
        ...
        action: () => {
          if (window.TaskStatisticsManager.open) {
            ...
            setTimeout(() => {
              const categoriesTab = document.querySelector(
                '.tab-button[data-tab="categories"]',
              );
              if (categoriesTab) {
                categoriesTab.click();
              }
      ...
      registerCommand({
        ...
        action: () => {
          if (window.TaskStatisticsManager.open) {
            ...
            setTimeout(() => {
              const dailyTab = document.querySelector(
                '.tab-button[data-tab="daily"]',
              );
              if (dailyTab) {
                dailyTab.click();
              }
            ...
            if (nodeId) {
              ...
              setTimeout(() => {
                ...
                if (nodeSelector) {
                  ...
                  const option = Array.from(nodeSelector.options).find(
                    (opt) => opt.value === nodeId,
                  );
                  if (option) {
      ...
      registerCommand({
        ...
        action: () => {
          if (window.WordFrequencyManager.openModal) {
            ...
            setTimeout(() => {
              const refreshButton =
                document.getElementById("refresh-word-freq");
              if (refreshButton) {
                refreshButton.click();
              }
            }, 500);
    ...
    if (window.DevTestPanelManager) {
          ...
          if (window.DevTestPanelManager.loadStatistics) {
            ...
            setTimeout(() => {
              ...
              if (statsTab) {
                ...
                setTimeout(() => {
                  const refreshButton =
                    document.getElementById("refresh-statistics");
                  if (refreshButton) {
                    refreshButton.click();
                  }
                }, 100);
      ...
      registerCommand({
        ...
        action: () => {
          ...
          setTimeout(() => {
            const entriesTab = document.querySelector(
              '.tab[data-tab="entries"]',
            );
            if (entriesTab) {
              entriesTab.click();
            }
      ...
      registerCommand({
        ...
        action: () => {
          ...
          setTimeout(() => {
            const addEntryTab = document.querySelector(
              '.tab[data-tab="add-entry"]',
            );
            if (addEntryTab) {
              addEntryTab.click();
            }
    ...
    if (window.GraphManagementUI) {
      ...
      registerCommand({
        ...
        action: () => {
          ...
          setTimeout(() => {
            const verticesTab = document.querySelector(
              '.tab-btn[data-tab="vertices"]',
            );
            if (verticesTab) {
              verticesTab.click();
            }
      ...
      registerCommand({
        ...
        action: () => {
          ...
          setTimeout(() => {
            const edgesTab = document.querySelector(
              '.tab-btn[data-tab="edges"]',
            );
            if (edgesTab) {
              edgesTab.click();
            }
      ...
      registerCommand({
        ...
        action: () => {
          ...
          setTimeout(() => {
            const refreshVerticesBtn = document.getElementById(
              "refresh-vertices-btn",
            );
            const refreshEdgesBtn =
              document.getElementById("refresh-edges-btn");
    ...
    if (window.GraphAnalysisVisualizer) {
      ...
      registerCommand({
        ...
        action: () => {
          ...
          setTimeout(() => {
            ...
            const applyLayoutBtn =
              document.getElementById("apply-graph-layout");
      ...
      registerCommand({
        ...
        action: () => {
          ...
          setTimeout(() => {
            const centralitySelector = document.getElementById(
      ...
      registerCommand({
        ...
        action: () => {
          ...
          setTimeout(() => {
            const communitySelector = document.getElementById(
              "community-algorithm",
            );
            const detectCommunitiesBtn =
              document.getElementById("detect-communities");
  ...
  function isPluginEnabled(pluginId) {
    return (
      ...
      window.PluginManager.isPluginEnabled &&
      window.PluginManager.isPluginEnabled(pluginId)
    );
  }
  ...
  function registerCodeGraphCommands() {
    ...
    if (window.CodeGraphManager && isPluginEnabled("codeGraphManager")) {
      registerCommand({
        ...
        action: () => {
          if (isPluginEnabled("codeGraphManager")) {
            ...
            alert(
              "Code Graph (Legacy) plugin is disabled. Please enable it in Settings > Plugins.",
            );
          }
        },
      ...
      window.CodeGraphManager &&
      !isPluginEnabled("codeGraphManager")
    ) {
      // Don't register any commands if plugin is disabled
      console.log(
        "Code Graph (Legacy) commands not registered - plugin is disabled",
      );
    }
    ...
    if (window.NewCodeGraphManager && isPluginEnabled("newCodeGraphManager")) {
      registerCommand({
        ...
        action: () => {
          if (isPluginEnabled("newCodeGraphManager")) {
            ...
            alert(
              "New Code Graph plugin is disabled. Please enable it in Settings > Plugins.",
            );
          }
        },
        category: "Code Analysis",
      ...
      window.NewCodeGraphManager &&
      !isPluginEnabled("newCodeGraphManager")
    ) {
      // Don't register any commands if plugin is disabled
      console.log(
        "New Code Graph commands not registered - plugin is disabled",
      );
    }

    // Check if Enhanced CodeGraphManager exists AND plugin is enabled
    if (
      window.EnhancedCodeGraphManager &&
      isPluginEnabled("enhancedCodeGraphManager")
    ) {
      registerCommand({
        ...
        action: () => {
          if (isPluginEnabled("enhancedCodeGraphManager")) {
            ...
            alert(
              "Enhanced Code Graph plugin is disabled. Please enable it in Settings > Plugins.",
            );
          }
        },
        category: "Code Analysis",
      ...
      // Don't register any commands if plugin is disabled
      console.log(
        "Enhanced Code Graph commands not registered - plugin is disabled",
      );
    }
  }
